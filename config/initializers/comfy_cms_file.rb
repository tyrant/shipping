# # Carbon copy of the original CMS class - apart from commenting out in line 35. We want multiple copies.
...
#       do_not_validate_attachment_type :file
#     end
#   end
...
#   validates :file_file_name, :uniqueness => {:scope => [:site_id, :block_id]}
