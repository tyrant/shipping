    ...
    keydown: function()
    {
      return {
        ...
        insertAfterLastElement: function(element)
        {
          ...
          if (last.length === 0 && last[0] !== element)
          {
    ...
    paste: function()
    {
      return {
        init: function(e)
        {
          ...
          var html = data.getData('text/html') || text;
          var msword = (html.match(/class="?Mso|style="[^"]*\bmso-|style='[^'']*\bmso-|w:WordDocument/i));
