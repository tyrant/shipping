...
(function() {
  ...
  $(function() {
    ...
    carousel = function() {};
    close = function() {
      return $('.flash button.close').on('click', function() {
        return $('.flash').remove();
      });
    };
    search = function() {
      var blah;
      return blah = setInterval(function() {
        var searchBox;
      ...
      $('#load_more').on('click', function() {
        ...
        return $.get("/more_news?before=" + earliestTimestamp, function(response) {
          ...
          for (i = 0, len = response.length; i < len; i++) {
            ...
            if (page.timestamp < earliestTimestamp) {
              results.push(earliestTimestamp = page.timestamp);
            } else {
              results.push(void 0);
            }
          }
